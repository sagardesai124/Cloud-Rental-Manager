...
class _TenantSummaryMobileState extends State<TenantSummaryMobile>
  ...
  /// ("Balance: $2,311.86 Balance Due"). Hidden until the figure is known so
  ...
  String _displayEndDate(String? endDate, DateProvider dateProvider) {
    ...
    final year = endDate.length >= 4 ? int.tryParse(endDate.substring(0, 4)) : null;
  ...
  Future<void> _fetchTenantBalance() async {
    try {
      // Same source the Financial tab uses to show a lease balance
      // (GET /api/payment/charges_payments/{leaseId}). The server computes the
      // figure via LeaseController.CalculateBalanceForLease.
      final ledger =
                                                                    ...
                                                                    for (var i =
                                                                      ...
                                                                      TableRow(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          _buildDataCell(
                                                                            // Web parity: web formats these before rendering, so show the
                                                                            // display date, not the raw ISO timestamp from the API.
  ...
  // Label (grey) above value (navy) — matches the web Tenant Information card.
                                                            ...
                                                            for (var i = 0;
                                                              ...
                                                              TableRow(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  _buildDataCell(
                                                                    // Web parity: show the formatted display date, not the raw
                                                                    // ISO timestamp the API returns.
                                                                    Provider.of<DateProvider>(context, listen: false)
                                                                        .formatCurrentDate(_pagedData[i].effectiveDate ?? ''),
                                                                    isDeleted: _pagedData[i]
                                                                            .isDelete ==
                                                                        true,
                                                                  ),
                                                                  _buildDataCell(
                                                                    Provider.of<DateProvider>(context, listen: false)
                                                                        .formatCurrentDate(_pagedData[i].expirationDate ?? ''),
                                                                    isDeleted: _pagedData[i]
                                                                            .isDelete ==
                                                                        true,
                                                                  ),
