...
import 'package:three_zero_two_property/screens/Leasing/Applicants/Summary/ContactInfoContent.dart';
...
class _applicant_summeryState extends State<applicant_summery>
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(context, isapplicantupdate); // Pass back whether refresh is needed
